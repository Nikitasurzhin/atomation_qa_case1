...
class TextBoxPage(BasePage):
    ...
    def fill_all_fields(self):
        ...
        self.elements_are_visible(self.locators.FULL_NAME)[0].send_keys(full_name)
        self.elements_are_visible(self.locators.EMAIL)[0].send_keys(email)
        self.elements_are_visible(self.locators.CURRENT_ADDRESS)[0].send_keys(current_address)
        self.elements_are_visible(self.locators.PERMANENT_ADDRESS)[0].send_keys(permanent_address)
        self.elements_are_visible(self.locators.SUBMIT)[0].click()
...
class WebTablePage(BasePage):
    ...
    def check_new_added_person(self):
        people_list = self.elements_are_presents(self.locators.FULL_PEOPLE_LIST)
        data = []
    ...
    def check_count_rows(self):
        list_rows = self.elements_are_presents(self.locators.FULL_PEOPLE_LIST)
